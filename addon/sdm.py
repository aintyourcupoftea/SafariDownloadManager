...
ROOT = "/Users/aintyourcupoftea/Development/SafariDownloadManager"
STRATEGY_FILE = f"{ROOT}/state/STRATEGY"
STATE_FILE = f"{ROOT}/state/downloads.json"
RPC_URL = "http://127.0.0.1:6800/jsonrpc"
RPC_SECRET_FILE = f"{ROOT}/state/rpc.secret"
